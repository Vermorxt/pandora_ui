...
const componentName = Ui_Stat.Item
const selector = 'stat'
...
const component = (
  <Ui_Stat.Item {...defaultProps} ref={null}>
    Test
  </Ui_Stat.Item>
) as unknown as FC<{}>
...
const componentPropsDefault: SpecialPropsMerged[] = [{ prop: { center: true }, className: `place-items-center` }]
